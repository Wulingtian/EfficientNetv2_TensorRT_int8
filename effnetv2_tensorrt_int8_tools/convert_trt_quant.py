...
BATCH_SIZE = 8
BATCH = 30
CALIB_IMG_DIR = '../calibration_data'
onnx_model_path = "../effnetv2.onnx"
...
def main():
    ...
    engine_model_path = "models_save/effnetv2_int8.trt"
    calibration_table = 'models_save/effnetv2_calibration.cache'
